...
from src.models.Nodes import Predicate, ImplicationOperator, NandOperator


class TestImplicationOperator(unittest.TestCase):

    def setUp(self):
        self.l_child = Predicate('A')
        self.r_child = Predicate('B')
        self.binary = ImplicationOperator('>', self.l_child, self.r_child)

    def test_evaluate(self):
        print('test_implication_evaluate')
    ...
    def test_nandify(self):
        print('test_implication_nandify')
